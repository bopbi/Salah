...
class PrayTime {
    ...
    val none: Int = 0 // No adjustment
    val midNight: Int = 1 // middle of night
    val oneSeventh: Int = 2 // 1/7th of night
    val angleBased: Int = 3 // angle/60th of night
    // Time Formats
    val time24: Int = 0 // 24-hour format
    val time12: Int = 1 // 12-hour format
    val time12NS: Int = 2 // 12-hour format with no suffix
    val floating: Int = 3 // floating point number
    // Time Names
    ...
    private val timeZone1: Double
        get() {
            ...
            val hoursDiff = timez.rawOffset / 1000.0 / 3600
            return hoursDiff
        }
    ...
    private fun detectDaylightSaving(): Double {
        val timez = TimeZone.getDefault()
        val hoursDiff = timez.dstSavings.toDouble()
        return hoursDiff
    }
    ...
    private fun adjustHighLatTimes(times: DoubleArray): DoubleArray {
        ...
        // Adjust Isha
        val IshaAngle = if (methodParams[this.calcMethod]!![3] == 0.0) methodParams[this.calcMethod]!![4] else 18.0
        ...
        // Adjust Maghrib
        val MaghribAngle = if (methodParams[this.calcMethod]!![1] == 0.0) methodParams[this.calcMethod]!![2] else 4.0
